# Sefaria Full Corpus Native Layout Generator Implementation Plan

> **For Antigravity:** REQUIRED SUB-SKILL: Load executing-plans to implement this plan task-by-task.

**Goal:** Implement a comprehensive standalone build generator (`build_sefaria_full_viewer.py`) that strictly outputs 1:1 native macro-segment layouts for the entire Munk/Makbili multi-volume corpus into `viewer_sefaria_full/`, and execute an audit asserting zero missing translation anomalies.

**Architecture:** Create an independent generator mapping every multi-volume section sequentially via array index matching attached to responsive left-hand TOC drawers and slide-up footnote panels. Audit outputs programmatically to confirm absolute parity.

**Tech Stack:** Python, Vanilla HTML/CSS/JS.

---

### Task 1: Implement Full Corpus Generator (`build_sefaria_full_viewer.py`)

**Files:**
- Create: `/Users/rayhabbaz/Munk's Guide/build_sefaria_full_viewer.py`

**Step 1: Write full corpus generator implementation**
...
<body>
    ...
    <script>
        ...
        // Populate Drawer TOC dynamically Group by Group
    ...
    # Write unified Landing Index Page
    groups_html = ""
    groups_dict = {}
...
Run: `python build_sefaria_full_viewer.py`
Expected output ends with: `total sections populated in viewer_sefaria_full/`

**Step 3: Commit**

```bash
git add build_sefaria_full_viewer.py
git commit -m "feat: implement unified full corpus native generation fork covering all multi-volume prefaces, classical introductions, parts 1-3, and endnotes"
```

---

### Task 2: Implement Comprehensive Alignment Audit (`inspect_sefaria_full_alignment.py`)

**Files:**
- Create: `/Users/rayhabbaz/Munk's Guide/inspect_sefaria_full_alignment.py`

**Step 1: Write full corpus alignment inspection implementation**
...
**Step 2: Execute comprehensive alignment audit**

Run: `python inspect_sefaria_full_alignment.py`
Expected output ends with: `Detailed findings saved to alignment_report_sefaria_full.md`

**Step 3: Commit**

```bash
git add inspect_sefaria_full_alignment.py
git commit -m "test: implement comprehensive alignment audit suite verifying complete segment mapping parity across full Sefaria native corpus bundle"
```
